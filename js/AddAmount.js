...
function validateEnteredAmount(hundred,five_hundred,two_thousand) {
    if(hundred==0 && five_hundred==0 && two_thousand==0){
        return false;
    }
    return true;
}
...
function addAmount() {
    ...
    if(validateEnteredAmount(hundred,five_hundred,two_thousand)) {
        $("#statTable2").hide();
